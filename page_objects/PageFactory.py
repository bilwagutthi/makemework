...
from page_objects.Payment_Frame import Payment_Frame
...
class PageFactory():
    ...
    def get_page_object(page_name,base_url='http://weathershopper.pythonanywhere.com/',trailing_slash_flag=True):
        ...
        elif page_name in ["payment","pay"]:
            test_obj = Payment_Frame(base_url=base_url,trailing_slash_flag=trailing_slash_flag)
